...
var div = dom.create("<div>111. 我是插入的div</div>");
dom.after(test, div);

var div2 = dom.create("<div>333. 我是插入的儿子</div>");
dom.append(test, div2);

var div3 = dom.create('<div id="parent">222. 我是插入的爸爸</div>');
dom.wrap(test, div3);

// const nodes = dom.empty(document.querySelector('#empty'));
// console.log(nodes);

var nodes = dom.empty2(window.empty);
console.log(nodes);
...
//# sourceMappingURL=/main.01029401.map